...
window.I18N_STATIC = {
  ...
  '🌀 Studio-Logo beim Start': '🌀 Studio logo on start',
  '🎴 Kartenrücken': '🎴 Card back',
  '🐞 Debug-Ansicht': '🐞 Debug view',
  'Blendet Gitter und Messwerte ein - nur für die Fehlersuche.': 'Shows the grid and live metrics - for troubleshooting only.',
  '„Automatisch“ folgt der Systemeinstellung „Bewegung reduzieren“.': '"Automatic" follows the system setting "reduce motion".',
  'Schließen': 'Close',
...
window.I18N_SERVER_PATTERNS = [
  ...
  [/^(.+?) hat die Lobby verlassen\.$/, '$1 left the lobby.'],
  [/^Verlassen geht nur in der Lobby - im Spiel gibt es 🏳️ Aufgeben\.$/, 'Leaving is only possible in the lobby - in a running game use 🏳️ forfeit.'],
  [/^Du sitzt nicht an diesem Tisch\.$/, 'You are not seated at this table.'],
